...
using System.Text;
using UserApi.Repositories.v2;
using UserApi.Repositories.v2.Interfaces;
using UserApi.Services.v2;
...
public static class Bootstrap
{
    ...
    public static IServiceCollection AddFirestoreSettings(this IServiceCollection service, IConfiguration configuration)
    {
        var settings = configuration.GetSection("FirestoreDbSettings").Get<FirestoreDbSettings>();
        return service
            .AddSingleton(settings ?? throw new ArgumentNullException("Firestore configuration error"))
            .AddSingleton<FirestoreContext>();
    }
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection service)
    {
        return service
            ...
            .AddScoped<ICustomerRepository, CustomerRespository>();
    }
}           
